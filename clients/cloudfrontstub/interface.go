...
type Client interface {
	...
	CreateKeyGroupAsync(ctx workflow.Context, input *cloudfront.CreateKeyGroupInput) *CloudFrontCreateKeyGroupFuture
	...
	DeleteKeyGroupAsync(ctx workflow.Context, input *cloudfront.DeleteKeyGroupInput) *CloudFrontDeleteKeyGroupFuture
	...
	GetKeyGroupAsync(ctx workflow.Context, input *cloudfront.GetKeyGroupInput) *CloudFrontGetKeyGroupFuture

	GetKeyGroupConfig(ctx workflow.Context, input *cloudfront.GetKeyGroupConfigInput) (*cloudfront.GetKeyGroupConfigOutput, error)
	GetKeyGroupConfigAsync(ctx workflow.Context, input *cloudfront.GetKeyGroupConfigInput) *CloudFrontGetKeyGroupConfigFuture
	...
	ListDistributionsByKeyGroupAsync(ctx workflow.Context, input *cloudfront.ListDistributionsByKeyGroupInput) *CloudFrontListDistributionsByKeyGroupFuture
	...
	ListKeyGroupsAsync(ctx workflow.Context, input *cloudfront.ListKeyGroupsInput) *CloudFrontListKeyGroupsFuture
	...
	UpdateKeyGroupAsync(ctx workflow.Context, input *cloudfront.UpdateKeyGroupInput) *CloudFrontUpdateKeyGroupFuture
