...
type Client interface {
	...
	CreateOrganizationAsync(ctx workflow.Context, input *workmail.CreateOrganizationInput) *WorkMailCreateOrganizationFuture
	...
	DeleteOrganizationAsync(ctx workflow.Context, input *workmail.DeleteOrganizationInput) *WorkMailDeleteOrganizationFuture
