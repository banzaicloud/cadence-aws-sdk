...
type Client interface {
	...
	CreateContactAsync(ctx workflow.Context, input *sesv2.CreateContactInput) *SESV2CreateContactFuture

	CreateContactList(ctx workflow.Context, input *sesv2.CreateContactListInput) (*sesv2.CreateContactListOutput, error)
	CreateContactListAsync(ctx workflow.Context, input *sesv2.CreateContactListInput) *SESV2CreateContactListFuture
	...
	DeleteContactAsync(ctx workflow.Context, input *sesv2.DeleteContactInput) *SESV2DeleteContactFuture

	DeleteContactList(ctx workflow.Context, input *sesv2.DeleteContactListInput) (*sesv2.DeleteContactListOutput, error)
	DeleteContactListAsync(ctx workflow.Context, input *sesv2.DeleteContactListInput) *SESV2DeleteContactListFuture
	...
	GetContactAsync(ctx workflow.Context, input *sesv2.GetContactInput) *SESV2GetContactFuture

	GetContactList(ctx workflow.Context, input *sesv2.GetContactListInput) (*sesv2.GetContactListOutput, error)
	GetContactListAsync(ctx workflow.Context, input *sesv2.GetContactListInput) *SESV2GetContactListFuture
	...
	ListContactListsAsync(ctx workflow.Context, input *sesv2.ListContactListsInput) *SESV2ListContactListsFuture

	ListContacts(ctx workflow.Context, input *sesv2.ListContactsInput) (*sesv2.ListContactsOutput, error)
	ListContactsAsync(ctx workflow.Context, input *sesv2.ListContactsInput) *SESV2ListContactsFuture
	...
	UpdateContactAsync(ctx workflow.Context, input *sesv2.UpdateContactInput) *SESV2UpdateContactFuture

	UpdateContactList(ctx workflow.Context, input *sesv2.UpdateContactListInput) (*sesv2.UpdateContactListOutput, error)
	UpdateContactListAsync(ctx workflow.Context, input *sesv2.UpdateContactListInput) *SESV2UpdateContactListFuture
