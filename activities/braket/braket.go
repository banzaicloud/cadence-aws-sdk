...
func (a *Activities) ListTagsForResource(ctx context.Context, input *braket.ListTagsForResourceInput) (*braket.ListTagsForResourceOutput, error) {
	client, err := a.getClient(ctx)
	if err != nil {
		return nil, internal.EncodeError(err)
	}
...
func (a *Activities) TagResource(ctx context.Context, input *braket.TagResourceInput) (*braket.TagResourceOutput, error) {
	client, err := a.getClient(ctx)
	if err != nil {
		return nil, internal.EncodeError(err)
	}
...
func (a *Activities) UntagResource(ctx context.Context, input *braket.UntagResourceInput) (*braket.UntagResourceOutput, error) {
	client, err := a.getClient(ctx)
	if err != nil {
		return nil, internal.EncodeError(err)
	}
