...
import (
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/accessanalyzer"
	"github.com/banzaicloud/cadence-aws-sdk/activities/acm"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/backup"
	"github.com/banzaicloud/cadence-aws-sdk/activities/batch"
	"github.com/banzaicloud/cadence-aws-sdk/activities/braket"
	"github.com/banzaicloud/cadence-aws-sdk/activities/budgets"
	"github.com/banzaicloud/cadence-aws-sdk/activities/chime"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloud9"
	"github.com/banzaicloud/cadence-aws-sdk/activities/clouddirectory"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudformation"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudfront"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudhsm"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudhsmv2"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudsearch"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudsearchdomain"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudtrail"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudwatch"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudwatchevents"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cloudwatchlogs"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codeartifact"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codebuild"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codecommit"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codedeploy"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codeguruprofiler"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codegurureviewer"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codepipeline"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codestar"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codestarconnections"
	"github.com/banzaicloud/cadence-aws-sdk/activities/codestarnotifications"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cognitoidentity"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cognitoidentityprovider"
	"github.com/banzaicloud/cadence-aws-sdk/activities/cognitosync"
	"github.com/banzaicloud/cadence-aws-sdk/activities/comprehend"
	"github.com/banzaicloud/cadence-aws-sdk/activities/comprehendmedical"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/datasync"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/docdb"
	"github.com/banzaicloud/cadence-aws-sdk/activities/dynamodb"
	"github.com/banzaicloud/cadence-aws-sdk/activities/dynamodbstreams"
	"github.com/banzaicloud/cadence-aws-sdk/activities/ebs"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/elasticache"
	"github.com/banzaicloud/cadence-aws-sdk/activities/elasticbeanstalk"
	"github.com/banzaicloud/cadence-aws-sdk/activities/elasticinference"
	"github.com/banzaicloud/cadence-aws-sdk/activities/elasticsearchservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/elastictranscoder"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/forecastqueryservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/forecastservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/frauddetector"
	"github.com/banzaicloud/cadence-aws-sdk/activities/fsx"
	"github.com/banzaicloud/cadence-aws-sdk/activities/gamelift"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/imagebuilder"
	"github.com/banzaicloud/cadence-aws-sdk/activities/inspector"
	"github.com/banzaicloud/cadence-aws-sdk/activities/iot"
	"github.com/banzaicloud/cadence-aws-sdk/activities/iot1clickdevicesservice"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesis"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisanalytics"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisanalyticsv2"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisvideo"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisvideoarchivedmedia"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisvideomedia"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kinesisvideosignalingchannels"
	"github.com/banzaicloud/cadence-aws-sdk/activities/kms"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/managedblockchain"
	"github.com/banzaicloud/cadence-aws-sdk/activities/marketplacecatalog"
	"github.com/banzaicloud/cadence-aws-sdk/activities/marketplacecommerceanalytics"
	"github.com/banzaicloud/cadence-aws-sdk/activities/marketplaceentitlementservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/marketplacemetering"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediaconnect"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediaconvert"
	"github.com/banzaicloud/cadence-aws-sdk/activities/medialive"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediapackage"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediapackagevod"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediastore"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediastoredata"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mediatailor"
	"github.com/banzaicloud/cadence-aws-sdk/activities/migrationhub"
	"github.com/banzaicloud/cadence-aws-sdk/activities/migrationhubconfig"
	"github.com/banzaicloud/cadence-aws-sdk/activities/mobile"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/organizations"
	"github.com/banzaicloud/cadence-aws-sdk/activities/outposts"
	"github.com/banzaicloud/cadence-aws-sdk/activities/personalize"
	"github.com/banzaicloud/cadence-aws-sdk/activities/personalizeevents"
	"github.com/banzaicloud/cadence-aws-sdk/activities/personalizeruntime"
	"github.com/banzaicloud/cadence-aws-sdk/activities/pi"
	"github.com/banzaicloud/cadence-aws-sdk/activities/pinpoint"
	"github.com/banzaicloud/cadence-aws-sdk/activities/pinpointemail"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/ram"
	"github.com/banzaicloud/cadence-aws-sdk/activities/rds"
	"github.com/banzaicloud/cadence-aws-sdk/activities/rdsdataservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/redshift"
	"github.com/banzaicloud/cadence-aws-sdk/activities/redshiftdataapiservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/rekognition"
	"github.com/banzaicloud/cadence-aws-sdk/activities/resourcegroups"
	"github.com/banzaicloud/cadence-aws-sdk/activities/resourcegroupstaggingapi"
	"github.com/banzaicloud/cadence-aws-sdk/activities/robomaker"
	"github.com/banzaicloud/cadence-aws-sdk/activities/route53"
	"github.com/banzaicloud/cadence-aws-sdk/activities/route53domains"
	"github.com/banzaicloud/cadence-aws-sdk/activities/route53resolver"
	"github.com/banzaicloud/cadence-aws-sdk/activities/s3"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/secretsmanager"
	"github.com/banzaicloud/cadence-aws-sdk/activities/securityhub"
	"github.com/banzaicloud/cadence-aws-sdk/activities/serverlessapplicationrepository"
	"github.com/banzaicloud/cadence-aws-sdk/activities/servicecatalog"
	"github.com/banzaicloud/cadence-aws-sdk/activities/servicediscovery"
	"github.com/banzaicloud/cadence-aws-sdk/activities/servicequotas"
	"github.com/banzaicloud/cadence-aws-sdk/activities/ses"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sesv2"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sfn"
	"github.com/banzaicloud/cadence-aws-sdk/activities/shield"
	"github.com/banzaicloud/cadence-aws-sdk/activities/signer"
	"github.com/banzaicloud/cadence-aws-sdk/activities/simpledb"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sms"
	"github.com/banzaicloud/cadence-aws-sdk/activities/snowball"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sns"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sqs"
	"github.com/banzaicloud/cadence-aws-sdk/activities/ssm"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sso"
	"github.com/banzaicloud/cadence-aws-sdk/activities/ssoadmin"
	"github.com/banzaicloud/cadence-aws-sdk/activities/ssooidc"
	"github.com/banzaicloud/cadence-aws-sdk/activities/storagegateway"
	"github.com/banzaicloud/cadence-aws-sdk/activities/sts"
	"github.com/banzaicloud/cadence-aws-sdk/activities/support"
	"github.com/banzaicloud/cadence-aws-sdk/activities/swf"
	"github.com/banzaicloud/cadence-aws-sdk/activities/synthetics"
	"github.com/banzaicloud/cadence-aws-sdk/activities/textract"
	"github.com/banzaicloud/cadence-aws-sdk/activities/timestreamquery"
	"github.com/banzaicloud/cadence-aws-sdk/activities/timestreamwrite"
	"github.com/banzaicloud/cadence-aws-sdk/activities/transcribeservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/transcribestreamingservice"
	"github.com/banzaicloud/cadence-aws-sdk/activities/transfer"
	"github.com/banzaicloud/cadence-aws-sdk/activities/translate"
	...
	"github.com/banzaicloud/cadence-aws-sdk/activities/workmailmessageflow"
	"github.com/banzaicloud/cadence-aws-sdk/activities/workspaces"
	"github.com/banzaicloud/cadence-aws-sdk/activities/xray"
