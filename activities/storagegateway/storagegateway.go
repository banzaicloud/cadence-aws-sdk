...
func (a *Activities) UpdateSMBFileShareVisibility(ctx context.Context, input *storagegateway.UpdateSMBFileShareVisibilityInput) (*storagegateway.UpdateSMBFileShareVisibilityOutput, error) {
	client, err := a.getClient(ctx)
	if err != nil {
		return nil, internal.EncodeError(err)
	}
	output, err := client.UpdateSMBFileShareVisibilityWithContext(ctx, input)
